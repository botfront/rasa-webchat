...
export const SET_TOOLTIP_DISPLAYED = 'SET_TOOLTIP_DISPLAYED';
...
export const SET_PAGECHANGE_REGEX = 'SET_PAGECHANGE_REGEX';
export const SET_DOM_HIGHLIGHT = 'SET_DOM_HIGHLIGHT';
export const SET_CONTAINER_CSS = 'SET_CONTAINER_CSS';
export const SET_TEXT_CSS = 'SET_TEXT_CSS';
